    ...
    <div className='container-1'>
      <div className='box-1'>
        <main className="mt-4 p-4">
          ...
          <p><small className="text-muted">Read and write from any ERC20 Token smart contract on the Ropsten testnet blockchain. Use approve, transfer, transfer from and receive event messages from the blockchain.</small> </p>
          <br />
